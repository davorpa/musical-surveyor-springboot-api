...
/**
 * Input object for creating a new {@code Prize}.
 *
 ...
 */
public class CreatePrizeInput extends BaseValueObject implements CreateInputCmd // NOSONAR
{
    @Serial
    private static final long serialVersionUID = 978795304631548779L;
    ...
    /**
     * Constructs a new {@link CreatePrizeInput} with the given arguments.
     *
     * @param title         the prize title
     * @param description   the prize description (optional)
     * @param monetaryValue the prize monetary value
     */
    public CreatePrizeInput(String title, String description, BigDecimal monetaryValue) {
        super();
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        CreatePrizeInput other = (CreatePrizeInput) o;
