...
/**
 * Input object for finding {@code Artist} instances.
 *
 ...
 */
public class FindArtistsInput extends BaseSortableFindInputCmd // NOSONAR
{
    @Serial
    private static final long serialVersionUID = -1005702181697836040L;

    /**
     * Constructs a new {@link FindArtistsInput} with the given arguments.
     *
     ...
     */
    public FindArtistsInput(int pageNumber, int pageSize, Sort sort) {
