...
/**
 * Input object for creating a new {@code Survey}.
 *
 ...
 */
public class CreateSurveyInput extends BaseValueObject implements CreateInputCmd // NOSONAR
{
    @Serial
    private static final long serialVersionUID = -7952507418939534374L;
    ...
    /**
     * Constructs a new {@link CreateSurveyInput} with the given arguments.
     *
     ...
     */
    public CreateSurveyInput(String title, String description,
    ...
    public boolean equals(Object o) {
        ...
        CreateSurveyInput other = (CreateSurveyInput) o;
    ...
    protected String defineObjAttrs() {
        return String.format(
            "title='%s', startDate='%s', endDate='%s', config=%s, description=%s",
